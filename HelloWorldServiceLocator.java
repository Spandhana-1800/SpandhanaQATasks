...
package io.egen.soap;

public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements io.egen.soap.HelloWorldService {
    ...
    public io.egen.soap.HelloWorld getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public io.egen.soap.HelloWorld getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            io.egen.soap.HelloWorldSoapBindingStub _stub = new io.egen.soap.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (io.egen.soap.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                io.egen.soap.HelloWorldSoapBindingStub _stub = new io.egen.soap.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://soap.egen.io", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://soap.egen.io", "HelloWorld"));
        }
